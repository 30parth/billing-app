    ...
    <div
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-4xl md:text-5xl font-extrabold leading-tight mb-8">
                Streamline Your<br />Billing Process.
            </h1>
            <p class="text-blue-100 text-lg md:text-xl max-w-sm leading-relaxed">
                Experience the most powerful and intuitive billing application designed for modern businesses.
            </p>
        </div>
            ...
            <form class="space-y-5" wire:submit="login">
                ...
                <div class="relative flex items-center justify-center w-full py-4">
                    ...
                    <div class="relative flex justify-center w-full text-sm">
                        <span class="px-4 text-gray-500 bg-white dark:bg-gray-800 dark:text-gray-400">Or continue
                            with</span>
                    </div>
                </div>
